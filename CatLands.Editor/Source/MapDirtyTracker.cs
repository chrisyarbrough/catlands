...
// 			return false;
// 		return x.FileVersion == y.FileVersion && x.Tilesets.SequenceEqual(y.Tilesets) && x.Tiles.SequenceEqual(y.Tiles);
// 	}
//
// 	public int GetHashCode(Map obj)
// 	{
// 		return HashCode.Combine(obj.FileVersion, obj.Tilesets, obj.Tiles);
// 	}
// }