...
{
	public static IEnumerable<Gizmo> Create(int id, Dictionary<int, Rect> rects)
	{
	...
	private static IEnumerable<Gizmo> CreateGroup(int id, IDictionary<int, Rect> rects)
	{
	...
	private static IEnumerable<Gizmo> CreateHandles(Gizmo gizmo, Action<Rect> setter)
	{
		// @formatter:off
